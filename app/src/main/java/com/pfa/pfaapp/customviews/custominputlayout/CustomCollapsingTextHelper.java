...
final class CustomCollapsingTextHelper {
    ...
    CustomCollapsingTextHelper(View view) {
        mView = view;
    ...
    private void calculateOffsets(final float fraction) {
        ...
        float mExpandedShadowRadius = 0;
        float mExpandedShadowDx = 0;
        float mExpandedShadowDy = 0;
        int mExpandedShadowColor = 0;
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        if(textSize==0)
            return;
//        Log.e("setInterpolatedTextSize","textSize=> "+textSize);
    ...
    private void ensureExpandedTexture() {
        ...
        float mTextureDescent = mTextPaint.descent();
    ...
    private static float lerp(float startValue, float endValue, float fraction,
        ...
        return CustomAnimationUtils.lerp(startValue, endValue, fraction);
    }
