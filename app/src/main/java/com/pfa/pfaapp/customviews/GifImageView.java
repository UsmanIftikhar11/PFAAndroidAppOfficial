...
public class GifImageView  extends View {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
        ...
        @SuppressLint("CustomViewStyleable") final TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.GifView, defStyle, R.style.Widget_GifView);

        //-1 is default value
        int mMovieResourceId = array.getResourceId(R.styleable.GifView_gif, -1);
