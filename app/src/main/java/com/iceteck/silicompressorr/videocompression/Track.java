...
public class Track {
    ...
    Track(int id, MediaFormat format, boolean isAudio) {
        trackId = id;
        if (!isAudio) {
    ...
    void addSample(long offset, MediaCodec.BufferInfo bufferInfo) {
    ...
    ArrayList<Long> getSampleDurations() {
