...
public class MediaController {
    ...
    private static int selectColorFormat(MediaCodecInfo codecInfo) {
        MediaCodecInfo.CodecCapabilities capabilities = codecInfo.getCapabilitiesForType(MediaController.MIME_TYPE);
    ...
    public static class VideoConvertRunnable implements Runnable {
        ...
        static void runConversion(final String videoPath, final File dest) {
...
//    }
                    ...
                    if (info.size < 0) {
                        ...
                        if (end < 0 || info.presentationTimeUs < end) {
                            ...
                            if (mediaMuxer.writeSampleData(muxerTrackIndex, buffer, info, isAudio)) {
                                ...
                                Log.e("writeSampleData", "writeSampleData MediaController.java line 207");
                            }
                            extractor.advance();
                        } else {
                            eof = true;
     ...
     * @return
     */
    private void convertVideo(final String sourcePath, File destDir) {
        convertVideo(sourcePath, destDir, 0, 0, 0);
    }
    ...
    public boolean convertVideo(final String sourcePath, File destDir, int outWidth, int outHeight, int outBitrate) {
        try {
            ...
            int bitrate = outBitrate > 0 ? outBitrate : (DEFAULT_VIDEO_BITRATE); //2 is multiplied by Aijaz
            int rotateRender = 0;
                        ...
                        try {
                            ...
                            if (processorType == PROCESSOR_TYPE_OTHER) {
                                ...
                                if (processorType != PROCESSOR_TYPE_TI) {
                                    if (processorType == PROCESSOR_TYPE_MTK) {
